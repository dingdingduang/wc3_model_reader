...
/**
 * A stationary animated 3D MDX projectile.
 *
 * <p>It has no pickup item, cannot be pushed, selected, attacked, or physically
 * collided with, and ignores entity and block contact.</p>
 */
public class AnimatedMdxProjectile extends StationaryMdxProjectile
        implements MdxAnimationSource, MdxModelScaleSource, MdxModelSource,
        MdxLightingSource {

    public static final float DEFAULT_MODEL_SCALE = AnimatedMdxEntity.DEFAULT_MODEL_SCALE;
    public static final float MAX_MODEL_SCALE = AnimatedMdxEntity.MAX_MODEL_SCALE;
    public static final ResourceLocation DEFAULT_MODEL_ID = AnimatedMdxEntity.DEFAULT_MODEL_ID;

    private static final EntityDataAccessor<String> ANIMATION_NAME =
            SynchedEntityData.defineId(AnimatedMdxProjectile.class, EntityDataSerializers.STRING);
    private static final EntityDataAccessor<Integer> ANIMATION_START_TICK =
            SynchedEntityData.defineId(AnimatedMdxProjectile.class, EntityDataSerializers.INT);
    private static final EntityDataAccessor<Float> MODEL_SCALE =
            SynchedEntityData.defineId(AnimatedMdxProjectile.class, EntityDataSerializers.FLOAT);
    private static final EntityDataAccessor<String> MODEL_ID =
            SynchedEntityData.defineId(AnimatedMdxProjectile.class, EntityDataSerializers.STRING);
    private static final EntityDataAccessor<Boolean> AFFECTED_BY_LIGHT =
            SynchedEntityData.defineId(AnimatedMdxProjectile.class, EntityDataSerializers.BOOLEAN);

    public AnimatedMdxProjectile(
            EntityType<? extends AnimatedMdxProjectile> entityType,
            Level level
    ) {
        super(entityType, level);
    }

    public AnimatedMdxProjectile(Level level, LivingEntity owner) {
        super(ModEntityTypes.ANIMATED_MDX_PROJECTILE.get(), owner, level);
    }
